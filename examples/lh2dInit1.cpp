...
int main(int argc, char *argv[]) {
  ...
  if (argc < NoFakeDataArgc) {
	...
	ssout<<dataconstraintoutFile<<".root";
      ...
      const std::string &UnOscfile = argv[11];
	...
	OscPromptE(UnOscfile, tempFile,FakeDatad21,FakeDatas12,FakeDatas13,distances[i]);   //oscillate each pdf -> outputs a pruned ntuple with an oscillated EPrompt positron spectrum called tempFile, to be used below to fill a reactorPdf
